# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-02-11 15:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('votes_count', models.CharField(choices=[('U', 'Unlimited'), ('N', 'Normal'), ('B', 'Blocked')], default='N', max_length=1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_image', models.ImageField(blank=True, upload_to='2017/2/11/')),
                ('image_url', models.URLField(blank=True, max_length=1000, null=True)),
                ('main_image_srcset', models.TextField(blank=True, null=True)),
                ('created', models.DateTimeField(auto_now_add=True)),
